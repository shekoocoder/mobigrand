...
describe('AccidentComponent', () => {
  ...
  let mockAccidentService;
  let mockDataService

  beforeEach(async(() => {

    mockAccidentService = sinon.createStubInstance(AccidentService);
    mockAccidentService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: AccidentService, useValue: mockAccidentService },
